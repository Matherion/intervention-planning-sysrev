...
generateChecklistElements <- function(node) {
  ...
  if (isRecursive(node[[recursionColName]]) && !isTrue(node[[recursionColName]])) {
    ...
    return(paste0("<div class='metabefor-checkbox-container'>",
                  ...
                  node$ChecklistTitle,
                  "<p class='metabefor-checkbox-description'>",
                  node$ChecklistDescription,
                  "</p>\n",
                  '<div class="btn-group metabefor-buttongroup" role="group" aria-label="Options">\n',
                  '<button type="button" class="btn btn-success">Did this</button>\n',
                  '<button type="button" class="btn btn-danger">Did not do this</button>\n',
                  '<button type="button" class="btn btn-primary">Not applicable</button>\n',
                  "</div>\n",
