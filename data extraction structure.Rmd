...
extractionScriptTree$Do(function(node) SetNodeStyle(node, fontcolor = "orange",
                                                    color='orange'),
                        filterFun = function(node) return(ifelse(is.null(node$Recursion), FALSE, TRUE)));
extractionScriptTree$Do(function(node) SetNodeStyle(node, style = "dotted",
                                                    fontcolor = "orange",
                                                    color='orange'),
                        filterFun = function(node) return(ifelse(is.null(node$Recursion), FALSE, ifelse((node$Recursion!='TRUE'), TRUE, FALSE))));
